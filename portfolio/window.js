class Window {
        constructor() {
                ...
                this.links = {
                        "projects-perlin": new LinkDef("h4", "projects-perlin" + this.ID, "Perlin Noise", "JS | July 2023", "assets/perlinThumb.png", false, "Implemented perlin noise on the GPU from scratch. Used a few layers of this noise to generate some basic terrain. Using this to work out some 3D rendering and lighting.", "perlin"),
                        "projects-gol": new LinkDef("h4", "projects-gol" + this.ID, "Game of Life", "JS | June 2023", "assets/golThumb.png", false, "Conway's Game of Life. Used WebGPU compute shaders for this, runs really well, but requires a browser that supports it(Chrome or Edge rn).", "gol"),
                        "projects-webGPU": new LinkDef("h4", "projects-webGPU" + this.ID, "WebGPU", "JS | May 2023", "assets/WGPUThumb.png", false, "WebGPU Test, programmed in Rust and compiled to WASM. Can compile this to native as well. Write once, run anywhere, very cool.", "webGPU"),
