class Window {
    ...
    home(){
        ...
        // createLink("h4", "projects-gol"+this.ID, "Game of Life", "JS | June 2023", "assets/golThumb.png", false, "Conway's Game of Life. Used WebGPU compute shaders for this, runs really well, but requires a browser that supports it(Chrome or Edge rn).","gol",  demos);
            createLink("h4", "projects-perlin"+this.ID, "Perlin Noise", "JS | July 2023", "assets/perlinThumb.png", false, "Implemented perlin noise on the GPU from scratch. Used a few layers of this noise to generate some basic terrain. Using this to work out some 3D rendering and lighting.","perlin",  demos);
            createLink("h4", "projects-gol"+this.ID, "Game of Life", "JS | June 2023", "assets/golThumb.png", false, "Conway's Game of Life. Used WebGPU compute shaders for this, runs really well, but requires a browser that supports it(Chrome or Edge rn).","gol",  demos);
            createLink("h4", "projects-webGPU"+this.ID, "WebGPU", "JS | May 2023", "assets/WGPUThumb.png", false, "WebGPU Test, programmed in Rust and compiled to WASM. Can compile this to native as well. Write once, run anywhere, very cool.","webGPU",  demos);
            createLink("h4", "demos-pLife"+this.ID, "Particle Life", "JS | January 2023", "assets/pLifeThumb.png", false, "Particle Life, inspired by this video: https://www.youtube.com/watch?v=p4YirERTVF0","pLife",  demos);
            createLink("h4", "demos-webGL"+this.ID, "WebGL", "JS | December 2022", "assets/webGLThumb.png", false, "I'm trying to learn webGL, this is the program I'm using to do that. It will showcase the effects I've come up with.","webGL",  demos);
            createLink("h4", "demos-oscilloscopevideo"+this.ID, "Oscilloscope Video", "JS | September 2022",  "assets/oscilloscopeThumb.png", false, "I use this to provide video input to my CRT oscilloscope.","oscilloscopeVideo",demos);
            createLink("h4", "projects-oscilloscope"+this.ID, "CRT Oscilloscope", "Electronics | September 2022", "assets/CRTOscilloscopeThumb.png", true, "Fun electronics project, rewired a portable color CRT into a color X/Y oscilloscope/plotter. Image is controlled by audio(X/Y) and composite(Color).","oscilloscopeCover",  demos);
            createLink("h4", "demos-wireframe"+this.ID, "Wireframe", "JS | March 2022", "assets/wireframeThumb.png", false, 'Generates a wireframe triangle, click to add more points to the "model".', "wireframe",  demos);
            createLink("h4", "demos-sound"+this.ID, "Paint Clone", "JS | January 2022", "assets/paintThumb.png", false, "This is just a basic paint clone, only does black lines. The cool thing about it is that it has undo and redo. Considering that it was all done from scratch in about 1.5 hours, I'm pretty pleased with it.","paint",  demos);
            createLink("h4", "demos-handheld"+this.ID, "Arduino Handheld", "C++ | August 2021", "assets/handheldThumb.png", true, "Arduino based handheld, looks a bit like a DS.","handheld",  demos);
            //createLink("h4", "demos-keyboard"+this.ID, "C64 Keyboard Adapter", "C++ | August 2021", "assets/placeholderThumb.png", false, "Arduino Leonardo based Commodore 64 keyboard adapter. Allows a Commodore 64 to be used as a USB keyboard.","notFound",  demos);
            createLink("h4", "demos-crt"+this.ID, "CRT", "JS | April 2021", "assets/crtThumb.png", false, "This one is pretty cool. You give it an image and after some major lag, it draws it with a shadow mask CRT filter. Looks pretty cool with the right input.","crt",  demos);
            createLink("h4", "demos-spacegame"+this.ID, "Spacegame", "Java | June 2021", "assets/spacegameThumb.png", false, "Shoot em'up made in Java. Has a really cool star field effect.","spacegameCover",  demos);
            createLink("h4", "demos-3d"+this.ID, "Minecraft Demo", "JS | Spring 2021", "assets/minecraftDemoThumb.png", true, "A VERY basic Minecraft clone. The result of experimenting with Three.js.","minecraftDemo",  demos);
            createLink("h4", "demos-morse"+this.ID, "Morse Code", "JS | April 2021", "assets/morseThumb.png", false, "English to Morse Code translator. Vertically stacked.","morse",  demos);
            createLink("h4", "demos-linetest"+this.ID, "Line Test", "JS | April 2021", "assets/lineTestThumb.png", true, "Test of a line drawing algorithm. Pointless, but I made it.", "linetest",  demos);
            //createLink("h4", "demos-gba"+this.ID, "GBA Snowflake Generator", "C | February 2021", "assets/gbaThumb.png", true, "Port of my snowflake generator to the Game Boy Advance.","gbaCover",  demos);
            //createLink("h4", "demos-dino"+this.ID, "C64 Dino Platformer", "C64 BASIC | September 2020", "assets/dinoThumb.png", false, 'C64 "platformer". Its really just a sprite that can walk and jump.',"notFound",  demos);
            //createLink("h4", "demos-c64"+this.ID, "Misc. C64 Programs", "C64 BASIC | Winter 2020", "assets/placeholderThumb.png", false, "Miscellaneous Commodore 64 programs.","notFound",  demos);
            createLink("h4", "demos-sound"+this.ID, "Synthesizer", "JS | July 2020", "assets/soundThumb.png", true, "This is a simple synthesizer, takes a frequency and wave type. Plays the sound and draws an approximation of the sound wave with math.","synth",  demos);
            createLink("h4", "demos-snowflake"+this.ID, "Snowflake Generator", "JS | November 2019", "assets/smallSnowflakeThumb.png", true, "Randomly generates snowflakes. Snowflakes can be animated and modified.","snowflake",  demos);
            createLink("h4", "demos-platformer"+this.ID, "Platformer", "JS | Summer 2019", "assets/platformerThumb.png", false, "This was my first attempt at a game, It's left unfinished and it's kinda horrible, but I learned a lot from it.","platformer",  demos);
            createLink("h4", "demos-graph"+this.ID, "Graphing Calculator", "JS | Spring 2019", "assets/graphThumb.png", true, "This was my first program. It graphs Cartesian, Polar, and Parametric functions.","graph",  demos);

            // createLink("h2", "todoLink", "", "Coming soon...", "todo", this.content);
    ...
    projects(){
        if(this.page != "projects"){
            this.clear();
            //createTextElement("h1", "projects-header"+this.ID, "text", "Projects", this.content);
            // createTextElement("p", "projects-desc"+this.ID, "text", "On this page you will find small/unfinished/experimental programs.", this.content);
            // createLink("h4", "projects-graph-header"+this.ID, "", "Graph", "graph", this.content);
            // createLink("h4", "projects-snowflake-header"+this.ID, "", "Snowflake", "snowflake", this.content);
            // createLink("h4", "projects-platformer-header"+this.ID, "", "Platformer", "platformer", this.content);
            let background = createElement("div", "", "projectsBackground", this.content);
            createLink("h4", "projects-perlin"+this.ID, "Perlin Noise", "JS | July 2023", "assets/perlinThumb.png", false, "Implemented perlin noise on the GPU from scratch. Used a few layers of this noise to generate some basic terrain. Using this to work out some 3D rendering and lighting.","perlin",  background);
            createLink("h4", "projects-gol"+this.ID, "Game of Life", "JS | June 2023", "assets/golThumb.png", false, "Conway's Game of Life. Used WebGPU compute shaders for this, runs really well, but requires a browser that supports it(Chrome or Edge rn).","gol",  background);
            createLink("h4", "projects-webGPU"+this.ID, "WebGPU", "JS | May 2023", "assets/WGPUThumb.png", false, "WebGPU Test, programmed in Rust and compiled to WASM. Can compile this to native as well. Write once, run anywhere, very cool.","webGPU",  background);
            createLink("h4", "projects-pLife"+this.ID, "Particle Life", "JS | January 2023", "assets/pLifeThumb.png", false, "Particle Life, inspired by this video: https://www.youtube.com/watch?v=p4YirERTVF0","pLife",  background);
            createLink("h4", "projects-webGL"+this.ID, "WebGL", "JS | December 2022", "assets/webGLThumb.png", false, "I'm trying to learn webGL, this is the program I'm using to do that. It will showcase the effects I've come up with.","webGL",  background);
            createLink("h4", "projects-oscilloscopevideo"+this.ID, "Oscilloscope Video", "JS | September 2022",  "assets/oscilloscopeThumb.png", false, "I use this to provide video input to my CRT oscilloscope.","oscilloscopeVideo",background);
            createLink("h4", "projects-oscilloscope"+this.ID, "CRT Oscilloscope", "Electronics | September 2022", "assets/CRTOscilloscopeThumb.png", true, "Fun electronics project, rewired a portable color CRT into a color X/Y oscilloscope/plotter. Image is controlled by audio(X/Y) and composite(Color).","oscilloscopeCover",  background);
            createLink("h4", "projects-wireframe"+this.ID, "Wireframe", "JS | March 2022", "assets/wireframeThumb.png", false, 'Generates a wireframe triangle, click to add more points to the "model".', "wireframe",  background);
            // createLink("h4", "projects-nn"+this.ID, "NN-Experiment", "JS | March 2022", "assets/nnThumb.png", false, ".","nn",  background);
            createLink("h4", "projects-sound"+this.ID, "Paint Clone", "JS | January 2022", "assets/paintThumb.png", false, "This is just a basic paint clone, only does black lines. The cool thing about it is that it has undo and redo. Considering that it was all done from scratch in about 1.5 hours, I'm pretty pleased with it.","paint",  background);
            createLink("h4", "projects-handheld"+this.ID, "Arduino Handheld", "Electronics/C++ | August 2021", "assets/handheldThumb.png", true, "Arduino based handheld, looks a bit like a DS.","handheld",  background);
            //   createLink("h4", "projects-keyboard"+this.ID, "C64 Keyboard Adapter", "C++ | August 2021", "assets/placeholderThumb.png", false, "Arduino Leonardo based Commodore 64 keyboard adapter. Allows a Commodore 64 to be used as a USB keyboard.","notFound",  background);
            createLink("h4", "projects-crt"+this.ID, "CRT", "JS | April 2021", "assets/crtThumb.png", false, "This one is pretty cool. You give it an image and after some major lag, it draws it with a shadow mask CRT filter. Looks pretty cool with the right input.","crt",  background);
            createLink("h4", "projects-spacegame"+this.ID, "Spacegame", "Java | June 2021", "assets/spacegameThumb.png", false, "Shoot em'up made in Java. Has a really cool star field effect.","spacegameCover",  background);
            createLink("h4", "projects-3d"+this.ID, "Minecraft Demo", "JS | Spring 2021", "assets/minecraftDemoThumb.png", true, "A VERY basic Minecraft clone. The result of experimenting with Three.js.","minecraftDemo",  background);
            createLink("h4", "projects-morse"+this.ID, "Morse Code", "JS | April 2021", "assets/morseThumb.png", false, "English to Morse Code translator. Vertically stacked.","morse",  background);
            createLink("h4", "projects-linetest"+this.ID, "Line Test", "JS | April 2021", "assets/lineTestThumb.png", true, "Test of a line drawing algorithm. Pointless, but I made it.", "linetest",  background);
            //   createLink("h4", "projects-gba"+this.ID, "GBA Snowflake Generator", "C | February 2021", "assets/gbaThumb.png", true, "Port of my snowflake generator to the Game Boy Advance.","gbaCover",  background);
            //   createLink("h4", "projects-dino"+this.ID, "C64 Dino Platformer", "C64 BASIC | September 2020", "assets/dinoThumb.png", false, 'C64 "platformer". Its really just a sprite that can walk and jump.',"notFound",  background);
            //   createLink("h4", "projects-c64"+this.ID, "Misc. C64 Programs", "C64 BASIC | Winter 2020", "assets/placeholderThumb.png", false, "Miscellaneous Commodore 64 programs.","notFound",  background);
            createLink("h4", "projects-sound"+this.ID, "Synthesizer", "JS | July 2020", "assets/soundThumb.png", true, "This is a simple synthesizer, takes a frequency and wave type. Plays the sound and draws an approximation of the sound wave with math.","synth",  background);
            createLink("h4", "projects-snowflake"+this.ID, "Snowflake Generator", "JS | November 2019", "assets/smallSnowflakeThumb.png", true, "Randomly generates snowflakes. Snowflakes can be animated and modified.","snowflake",  background);
            createLink("h4", "projects-platformer"+this.ID, "Platformer", "JS | Summer 2019", "assets/platformerThumb.png", false, "This was my first attempt at a game, It's left unfinished and it's kinda horrible, but I learned a lot from it.","platformer",  background);
            createLink("h4", "projects-graph"+this.ID, "Graphing Calculator", "JS | Spring 2019", "assets/graphThumb.png", true, "This was my first program. It graphs Cartesian, Polar, and Parametric functions.","graph",  background);
            ...
            // let temp1 = createLink("h4", "projects-oscilloscope"+this.ID, "CRT Oscilloscope", "Electronics | September 2022", "assets/CRTOscilloscopeThumb.png", true, "Fun electronics project, rewired a portable color CRT into a color X/Y oscilloscope/plotter. Image is controlled by audio(X/Y) and composite(Color).","oscilloscopeCover",  background);
            let temp2 = createLink("h4", "projects-keyboard"+this.ID, "C64 Keyboard Adapter", "C++ | August 2021", "assets/K64Thumb.png", true, "Arduino Leonardo based Commodore 64 keyboard adapter. Allows a Commodore 64 to be used as a USB keyboard.","notFound",  background);
            let temp3 = createLink("h4", "projects-gba"+this.ID, "GBA Snowflake Generator", "C | February 2021", "assets/gbaThumb.png", true, "Port of my snowflake generator to the Game Boy Advance.","gbaCover",  background);
            let temp4 = createLink("h4", "projects-dino"+this.ID, "C64 Dino Platformer", "C64 BASIC | September 2020", "assets/dinoThumb.png", false, "C64 platformer. It's really just a sprite that can walk and jump.","notFound",  background);
            // let temp5 = createLink("h4", "projects-c64"+this.ID, "Misc. C64 Programs", "C64 BASIC | Winter 2020", "assets/placeholderThumb.png", false, "Miscellaneous Commodore 64 programs.","notFound",  background);
            ...
            // createLink("h4", "projects-wasm"+this.ID, "WASM Test",  "assets/wasmThumb.png", "WASM Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.","WASMTest",  this.content);
                
            // createLink("h4", "projects-paint-header"+this.ID, "", "Paint", "paint", this.content);
                // createLink("h4", "projects-3d-header"+this.ID, "", "Minecraft Demo", "minecraftDemo", this.content);
                // createLink("h4", "projects-crt-header"+this.ID, "", "CRT", "crt", this.content);
                // createLink("h4", "projects-nn-header"+this.ID, "", "NN-Experiment", "nn", this.content);
                // createLink("h4", "projects-wireframe-header"+this.ID, "", "Wireframe", "wireframe", this.content);
                // createLink("h4", "projects-morse-header"+this.ID, "", "Morse Code", "morse", this.content);
                // createLink("h4", "projects-linetest-header"+this.ID, "", "Line Test", "linetest", this.content);
                // createLink("h4", "projects-wasm-header"+this.ID, "", "WASM Test", "WASMTest", this.content);
                // createLink("h4", "projects-oscilloscopevideo-header"+this.ID, "", "Oscilloscope Video", "OscilloscopeVideo", this.content);
...
function createLink(type, id, title, date, thumbnailSrc, antialiasing, description, page, parent){
    let container = createElement("div", id, "demoDiv", parent);
    // let textDiv = createElement("div", id+"-textDiv", "demoTextDiv", container);
    let titleDiv = createElement("div", id+"-title", "demoTitleDiv", container);
    let descDiv = createElement("div", id+"-description", "demoDescDiv", container);
    let image;
    if(antialiasing){
        image = createElement("img", id+"-thumbnail", "demoThumbImg antialiased", container);
    } else {
        image = createElement("img", id+"-thumbnail", "demoThumbImg", container);
    }
    let img = new Image(512,512);
    img.src = thumbnailSrc;
    image.src = img.src;
    let titleText = createTextElement(type, id, "text link demoTitleText", title, titleDiv);
    let dateText = createTextElement(type, id, "text demoDateText ", date, titleDiv);
    let descText = createTextElement(type, id, "text demoDescText", description, descDiv);
